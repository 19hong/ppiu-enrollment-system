...
router.get('/:id', authenticate, authorize('SUPER_ADMIN', 'REGISTRAR', 'DEPARTMENT_HEAD', 'LECTURER'), lecturerController.getById);
...
router.get('/:id/courses', authenticate, authorize('SUPER_ADMIN', 'REGISTRAR', 'LECTURER'), lecturerController.getCourses);

router.get('/:id/schedule', authenticate, authorize('SUPER_ADMIN', 'REGISTRAR', 'LECTURER'), lecturerController.getSchedule);
