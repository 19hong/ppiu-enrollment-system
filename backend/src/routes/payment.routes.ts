...
router.get('/:id', authenticate, authorize('SUPER_ADMIN', 'FINANCE_OFFICER', 'STUDENT'), paymentController.getById);

router.get('/:id/invoice', authenticate, authorize('SUPER_ADMIN', 'FINANCE_OFFICER', 'STUDENT'), paymentController.getInvoice);

router.get('/:id/receipt', authenticate, authorize('SUPER_ADMIN', 'FINANCE_OFFICER', 'STUDENT'), paymentController.getReceipt);
